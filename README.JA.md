...
このプロジェクトをあなた自身のものとして、あるいは、商用目的で公開しないで頂けるとありがたいです。
将来、このアプリをApp Storeに掲載するかもしれません。
...
また、デベロッパコミュニティーからの機能のリクエストやエラー/バグ報告は大歓迎です！
しかし、私自身初心者のため、修正法が分からない可能性があります。どのようなアイデア・提案も大変助かりますので、Issues / Discussionsタブにコメントを残して頂けるととても嬉しいです。
